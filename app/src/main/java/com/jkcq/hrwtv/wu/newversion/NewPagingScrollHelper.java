...
//                        Log.e("NewPaging","count: "+count+" pageCount: "+pageCount+" currentPage: "+currentPage);
                        if (currentPage < pageCount) {
                            if (currentPage == 1) {
                                if (listener != null) {
                                    listener.onChangePage(pageCount, currentPage);
                                }
...
//                                ((GridLayoutManager)mRecyclerView.getLayoutManager()).scrollToPositionWithOffset(0,0);
                                ...
                                mRecyclerView.scrollToPosition((currentPage - 1) * SEPARATE);
...
//                            Log.e("NewPaging", "currentPage == pageCount");
...
//                            ((GridLayoutManager)mRecyclerView.getLayoutManager()).scrollToPositionWithOffset(count-1,0);
    ...
    private OnPageListerner listener;

    public void setmOnScrollListener(OnPageListerner listener) {
        this.listener = listener;
    }

    public interface OnPageListerner {
        void onChangePage(int totalPage, int currentPage);
    }
