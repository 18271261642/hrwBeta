...
public class CountDownTimerUtil {
     ...
     * 开始倒计时
     */
    public static void StartToCountDown(long currentTime, Activity activity) {
    ...
    public class MyCountDownTimer extends CountDownTimer {
        ...
        public void onTick(long millisUntilFinished) {
            ...
            setmCancelled(false);
            onCountDownTimerListener.onNext(DateUtils.getLeftTimeFormatedStrings(millisUntilFinished));
        }
    ...
    public interface OnCountDownTimerListener {
        ...
        void onNext(String[] leftTimeFormatedStrings);
    }
}
