...
import com.jkcq.hrwtv.ui.view.refresh.AbListViewFooter;
import com.jkcq.hrwtv.ui.view.refresh.AbListViewHeader;
...
public class ViewUtils {
    ...
    /**
     * 描述：View树递归调用做适配. uiWidth = 1080; uiHeight = 700;
     * scaleContentView((RelativeLayout)initView(R.id.rootLayout));
