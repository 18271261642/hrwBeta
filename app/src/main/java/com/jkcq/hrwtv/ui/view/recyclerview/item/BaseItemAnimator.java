package com.jkcq.hrwtv.ui.view.recyclerview.item;
/*
...
//    }
  ...
  protected long getRemoveDelay(final ViewHolder holder) {
    return Math.abs(holder.getOldPosition() * getMoveDuration() / 4);
  }
  ...
  protected long getAddDelay(final ViewHolder holder) {
    return Math.abs(holder.getAdapterPosition() * getMoveDuration() / 4);
  }
