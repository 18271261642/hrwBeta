 ...
 */
package com.jkcq.hrwtv.ui.view.refresh;
...
import com.jkcq.hrwtv.util.ViewUtils;
import com.jkcq.hrwtv.ui.view.ProgressWheel;
...
public class AbListViewHeader extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        headerProgressBar = (ProgressWheel) findViewById(R.id.pull_to_refresh_progress);
        ...
        switch (state) {
            case STATE_NORMAL:
                ...
                if (lastRefreshTime == null) {
                    lastRefreshTime = DateUtils.getCurrentDate("HH:mm:ss");
