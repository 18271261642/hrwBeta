...
public class DialogUpgradeVersion extends Dialog {
    ...
    public DialogUpgradeVersion(Context context, OnButtonClick onClickShowView, String titelMsg) {

        this(context, R.style.MyDialogStyle, onClickShowView, titelMsg);

    }

    public DialogUpgradeVersion(Context context, int themeResId, OnButtonClick onClickShowView, String titleMsg) {
    ...
    protected DialogUpgradeVersion(Context context, boolean cancelable, OnCancelListener cancelListener, OnButtonClick onClickShowView) {
